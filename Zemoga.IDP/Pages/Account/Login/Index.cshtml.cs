...
using Zemoga.IDP.Pages.Login;
using Zemoga.IDP.Services;

namespace Zemoga.IDP.Pages.Account.Login;
...
public class Index : PageModel
{
    ...
    public async Task<IActionResult> OnPost()
    {
        ...
        if (ModelState.IsValid)
        {
            ...
            {
                Entities.User user = await _localUserService.GetUserByUserNameAsync(Input.Username);
                ...
                IdentityServerUser isuser = new(user.Subject)
                {
